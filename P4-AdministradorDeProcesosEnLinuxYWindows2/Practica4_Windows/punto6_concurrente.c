...
int main(){	
	...
	//Esperar la finalización del hilo 1
	WaitForSingleObject(manHilo1,INFINITE);	
	//Esperar la finalización del hilo 2
	WaitForSingleObject(manHilo2,INFINITE);	
	//Esperar la finalización del hilo 3
	WaitForSingleObject(manHilo3,INFINITE);	
	//Esperar la finallización del hilo 4
	...
	//Esperar la finalización del hilo 5
